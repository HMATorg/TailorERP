...
export const MEASUREMENT_POINTS: readonly MeasurementPoint[] = [
  { key: 'm1FrontLength', label: 'Total length (front)', labelAr: 'الطول الأمامي' },
  { key: 'm1BackLength', label: 'Total length (back)', labelAr: 'الطول الخلفي' },
  { key: 'm2ShoulderWidth', label: 'Shoulder', labelAr: 'الكتف' },
  { key: 'm3SleeveLeft', label: 'Sleeve (left)', labelAr: 'الكم الأيسر' },
  { key: 'm3SleeveRight', label: 'Sleeve (right)', labelAr: 'الكم الأيمن' },
